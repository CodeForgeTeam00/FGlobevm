            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
                ...
                <div className="max-w-xl">
                    ...
                    <h2 className="text-4xl sm:text-5xl font-serif text-gray-900 mb-6 leading-[1.2]">
                        Managed IT and Cybersecurity That <span className="text-[#1da1f2]">Scales</span> With You
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 items-start sm:items-center">
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-baseline text-[#1da1f2] font-serif mb-1">
                                ...
                                <span className="text-6xl font-bold leading-none">8</span>
                                <span className="text-lg font-medium text-gray-600 ml-1 font-sans">Years</span>
                            </div>
                ...
                <div className="relative">
                    ...
                    <div className="absolute -inset-4 bg-gradient-to-tr from-blue-50 to-emerald-50 rounded-[2.5rem] -z-10 transform rotate-2"></div>
